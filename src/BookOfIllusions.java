...
public class BookOfIllusions extends MouseAdapter {
	...
	JLabel Lable;
	JLabel Lable2;
	String tableimage = "tables1.jpg";
	String black = "980x.jpg";
	...
	private void createBook() {
		...
		Lable = loadImageFromComputer(tableimage);

		// 8. add your JLabel to the frame
		frame.add(Lable);
		// 9. call the pack() method on the frame
		frame.pack();
		JOptionPane.showMessageDialog(null, "Which one is bigger?????????? AYY LMAO");
	...
	public void mousePressed(MouseEvent e) {
		...
		Lable2 = loadImageFromComputer(black);
		frame.add(Lable2);
		// 14. pack the frame
		frame.pack();
		JOptionPane.showMessageDialog(null, "heheheHA (Put your finger over the middle)");
	}
